...
public class TasteProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPieChart.addPieSlice(new PieModel("Bitter", 2, Color.parseColor("#FE6DA8")));
        mPieChart.addPieSlice(new PieModel("Salty", 2, Color.parseColor("#56B7F1")));
        mPieChart.addPieSlice(new PieModel("Sour", 2, Color.parseColor("#CDA67F")));
        mPieChart.addPieSlice(new PieModel("Spicy", 2, Color.parseColor("#FED70E")));
        mPieChart.addPieSlice(new PieModel("Sweet", 2, Color.parseColor("#FED70E")));
